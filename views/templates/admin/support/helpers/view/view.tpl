...
<div class="row">
	...
	<div class="col-xs-12 col-sm-6 col-lg-8">
		<div class="panel">
			...
			<h3><i class="icon-life-bouy"></i> {l s='PrestaShop Support' mod='pssupport'}</h3>
			...
			<br/>{l s='You can also browse our User FAQ.' mod='pssupport'}</p>
				<div class="row">
					...
					<button type="button" class="btn btn-default" href="http://doc.prestashop.com/display/PS16/User+Guide">{l s='Read the User Guide' mod='pssupport'}</button>
					</div>
					<div class="col-xs-3 text-center">
					<button type="button" class="btn btn-default" href="http://doc.prestashop.com/display/PS16/FAQ">{l s='Go to User FAQ' mod='pssupport'}</button>
					</div>
				</div>
			<br/>
			<br/>
			...
			<h4><i class="icon-arrow-right"></i> {l s='...searched the Forum?' mod='pssupport'}</h4>
			...
			<button type="button" class="btn btn-default" href="http://www.prestashop.com/forums/">{l s='Search the Forum' mod='pssupport'</button>
			<br/>
			<br/>
			<br/>
			
			<h4><i class="icon-arrow-right"></i> {l s='Still at loss with a major issue?' mod='pssupport'}</h4>
			...
			<button type="button" class="btn btn-default" href="http://addons.prestashop.com/en/388-support">{l s='Open a support' mod='pssupport'}</button>
